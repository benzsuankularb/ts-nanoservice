import { BaseService, LocalServiceEventEmitter, Service, ServiceInstance, ServiceInstanceBuilder, Subscribe, serviceFactory } from "../src/index";
...
export class Service_C extends Service_B implements Service<ServiceInterface_C> {
